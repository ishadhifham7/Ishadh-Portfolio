    ...
    <section className="min-h-[calc(100vh-140px)] flex items-center justify-center relative">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            I turn lines of code into experiences people love. I build
            full-stack apps and enjoy exploring cloud technologies, always
            creating projects that solve problems and leave a mark.
          </motion.p>
