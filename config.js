  ...
  skills: [
    {
      ...
      skills: [
        ...
        { name: "React Native", level: "Advanced", hot: true },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "MongoDB", level: "Advance", hot: true },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Figma", level: "Advnaced" },
        { name: "Linux", level: "Intermediate" },
        { name: "Git", level: "Advanced" },
        { name: "Click Up", level: "Advanced" },
      ],
    },
  ],
  experiences: [
  ...
  contactInfo: [
    {
      ...
      label: "GitHub",
      value: "@ishadhifham7",
      link: `https://github.com/ishadhifham7`,
    },
    {
      icon: <HiMail className="w-5 h-5" />,
      label: "Email",
      value: "ishadhifham.com",
      link: "mailto:ishadhifham@gmail.com",
    },
    {
